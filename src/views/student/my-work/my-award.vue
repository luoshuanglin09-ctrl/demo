<template>
    <div>
      ...
      <div>
        ...
        <div>
          <el-dialog v-model="dialogFormVisible" title="上传获奖" style="width: 400px;">
            <el-form :model="form">
              <el-form-item label="题目" :label-width="formLabelWidth">
                <el-input style="width: 180px;" v-model="form.title" autocomplete="off" />
              </el-form-item>
              <el-form-item label="上传获奖" :label-width="formLabelWidth">
  ...
  import { $getprize } from '../../../api/paper/paper'
  ...
  const loadpaper = async () => {
    const res = await $getprize(searchpaper)
    console.log(res, 'res');
